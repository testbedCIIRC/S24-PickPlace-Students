...
def drawText(
    ...
    frame = cv2.putText(frame, text, position, cv2.FONT_HERSHEY_SIMPLEX, size, (0, 0, 0), 4)
    frame = cv2.putText(frame, text, position, cv2.FONT_HERSHEY_SIMPLEX, size, (255, 255, 255), 2)
    return frame
